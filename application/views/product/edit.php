...
<div class="p-4">
    <div class="relative flex flex-col min-w-0 mb-4 lg:mb-0 break-words bg-gray-50 dark:bg-gray-800 w-full shadow-lg rounded">
      <div class="rounded-t mb-0 px-0 border-0">
        ...
        <form enctype="multipart/form-data" action="<?= base_url('dashboard/product/edit/') . $product->id ?>" method="post">
          <div class="mb-4">
            <label for="name" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Name</label>
            <input value="<?= set_value('name', $product->name); ?>"  type="text" id="name" name="name" class="shadow-sm rounded-md w-full px-3 py-2 border border-gray-300 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500" placeholder="name" required>
          ...
          <div class="mb-4">
            ...
            <input value="<?= set_value('price', $product->price); ?>"  type="number" min="1" id="price" name="price" class="shadow-sm rounded-md w-full px-3 py-2 border border-gray-300 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500" placeholder="price" required>
          ...
          <div class="mb-4">
            ...
            <input value="<?= set_value('stock', $product->stock); ?>"  type="number" min="1" id="stock" name="stock" class="shadow-sm rounded-md w-full px-3 py-2 border border-gray-300 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500" placeholder="stock" required>
          ...
          <div class="mb-4">
            ...
            <?php if ($product->image) :?>
                <img id="preview-image" src="<?= base_url('public/uploads/') . $product->image ?>" class="image-preview mb-3" style="max-width: 200px">
            <?php else :?>
                <img id="preview-image" class="image-preview mb-3" style="max-width: 200px">
            <?php endif ?>
            <input onchange="previewImage()" type="file" id="image" name="image" class="shadow-sm bg-white rounded-md w-full px-3 py-2 border border-gray-300 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
